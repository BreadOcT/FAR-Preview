...
export const Input: React.FC<InputProps> = ({ label, error, icon, leftAddon, rightElement, className = '', containerClassName = '', ...props }) => {
  return (
    <div className={`w-full space-y-2 group ${containerClassName}`}>
      <label className="text-sm font-medium text-stone-600 dark:text-stone-400 group-focus-within:text-orange-500 transition-colors">
        {label}
      </label>
